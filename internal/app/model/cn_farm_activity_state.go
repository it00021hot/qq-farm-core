...
type FarmActivityState struct {
	...
	TenantID   uint64 `gorm:"column:tenant_id;not null;default:0;index;uniqueIndex:uk_tenant_account_act;comment:租户ID" json:"tenantId"`
	AccountID  uint64 `gorm:"column:account_id;not null;uniqueIndex:uk_tenant_account_act;index;comment:账号ID" json:"accountId"`
	ActivityID string `gorm:"column:activity_id;size:64;not null;uniqueIndex:uk_tenant_account_act;comment:活动ID" json:"activityId"`
...
func (m *FarmActivityState) GetTenantID() uint64   { return m.TenantID }
func (m *FarmActivityState) SetTenantID(id uint64) { m.TenantID = id }

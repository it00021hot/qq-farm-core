...
type FarmFriendGid struct {
	...
	AccountID uint64 `gorm:"column:account_id;not null;uniqueIndex:uk_account_gid;index;comment:账号ID" json:"accountId"`
	Gid       int64  `gorm:"column:gid;not null;uniqueIndex:uk_account_gid;comment:好友GID" json:"gid"`

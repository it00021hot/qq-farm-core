...
type FarmGameConfig struct {
	...
	Category   string `gorm:"column:category;size:64;not null;default:'';uniqueIndex:uk_game_cat_key;comment:分类 seed/item/..." json:"category"`
	ConfigKey  string `gorm:"column:config_key;size:64;not null;uniqueIndex:uk_game_cat_key;comment:配置键" json:"configKey"`

...
type SysRole struct {
	...
	ParentID  uint64 `gorm:"column:parent_id;not null;default:0;index;comment:上级角色ID 0为根" json:"parentId"`
	...
	IsSys     uint8  `gorm:"column:is_sys;not null;default:0;comment:是否系统角色 1：是 0：否" json:"isSys"`
	RoleType  uint8  `gorm:"column:role_type;not null;default:1;comment:角色类型 1：平台专用 2：可赋给租户用户" json:"roleType"`
